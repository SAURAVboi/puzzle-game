...
/*
In case you want to use a actual image file instead of a data url :
    ...
    switch (state) {
      ...
      case 120: // save state
        ...
        if (filesave) {
          ...
          try {
            localStorage.setItem("svpuzzle", savedString);
      ...
      case 150: // restore game
        ...
        if (filesave) {
          ...
          try {
            puzzle.restoredString = localStorage.getItem("svpuzzle");
